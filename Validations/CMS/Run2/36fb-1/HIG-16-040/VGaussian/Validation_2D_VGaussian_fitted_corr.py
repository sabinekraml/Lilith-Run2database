...
# f = open('HIG-16-040_Llh-2d-Grid68.txt', 'r')
f = open('HIG-16-040_Llh-2d-Grid95.txt', 'r')
...
def func(X, sig1p, sig1m, sig2p, sig2m, p):
    z1, z2 = X[:,0], X[:,1]
    z10, z20 = 1.181438622,	1.187975172
    V1 = sig1p * sig1m
    V1e = sig1p - sig1m
    V2 = sig2p * sig2m
    V2e = sig2p - sig2m
...
# Open the 1D grid files
f = open('HIG-16-040_Llh-2d-Grid.txt', 'r')
...
# plt.title("$\mu$ from CMS-HIG-16-040 (VGaussian, 68% CL, fitted corr)")
plt.title("$\mu$ from CMS-HIG-16-040 (VGaussian, 95% CL, fitted corr)")
