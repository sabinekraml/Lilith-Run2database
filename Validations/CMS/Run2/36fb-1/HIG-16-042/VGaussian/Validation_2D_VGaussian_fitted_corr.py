...
# f = open('HIG-16-042_Llh-2d-Grid68.txt', 'r')
f = open('HIG-16-042_Llh-2d-Grid95.txt', 'r')
...
def func(X, sig1p, sig1m, sig2p, sig2m, p):
    z1, z2 = X[:,0], X[:,1]
    z10, z20 = 0.7889827595842163, 1.367609254498714
    V1 = sig1p * sig1m
    V1e = sig1p - sig1m
    V2 = sig2p * sig2m
    V2e = sig2p - sig2m
...
# Open the 1D grid files
f = open('HIG-16-042_Llh-2d-Grid.txt', 'r')
...
xmax, ymax = 2.5, 2.5
(a, b) = (0.01, 0.01)
x2 = np.arange(-0.6, xmax, a, dtype=np.float)
...
# plt.title("$\mu$ from CMS-HIG-16-042 (VGaussian, 68% CL, fitted corr)")
plt.title("$\mu$ from CMS-HIG-16-042 (VGaussian, 95% CL, fitted corr)")
