...
# f = open('HIGG_2016-07_Cr-2d-Grid68.txt', 'r')
# f = open('HIGG_2016-07_Cr-2d-Grid95.txt', 'r')
# f = open('HIGG_2016-07_Llh-2d-Grid68.txt', 'r')
f = open('HIGG_2016-07_Llh-2d-Grid95.txt', 'r')
...
# Open the 1D grid files
# f = open('HIGG_2016-07_Cr-2d-GridFull.txt', 'r')
f = open('HIGG_2016-07_Llh-2d-GridFull.txt', 'r')
...
xmax, ymax = 17.5, 1.5
(a, b) = (0.01, 0.01)
x2 = np.arange(5, xmax, a, dtype=np.float)
y2 = np.arange(-0.3, ymax, b, dtype=np.float)
...
plt.xlabel(r'$\mu_{ZZ}^{ggF}$', fontsize=30)
plt.ylabel(r'$\mu_{ZZ}^{VBF}$', fontsize=30)
# plt.title("$\mu$ from ATLAS-HIGG-2016-07 (VGaussian, 68% CL, fitted corr)")
