...
y2 = np.arange(-1, ymax, b, dtype=np.float)
...
plt.xlabel(r'$\mu_{\tau\tau}^{ttH}$', fontsize=30)
plt.ylabel(r'$\mu_{VV}^{ttH}$', fontsize=30)
# plt.title("$\mu$ from ATLAS-HIGG-2017-02 (VGaussian, 68% CL, fitted corr)")
plt.title("$\mu$ from ATLAS-HIGG-2017-02 (VGaussian, 95% CL, fitted corr)")
