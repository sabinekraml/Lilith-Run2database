...
# # Data from Table 9
# # ggF
# cen2, sig2m, sig2p = 1.11, np.sqrt(0.2**2 + 0.06**2 + 0.04**2), np.sqrt(0.22**2+0.07**2+0.04**2)
# # VBF
# cen1, sig1m, sig1p = 4, np.sqrt(1.4**2 + 2*0.3**2), np.sqrt(1.7**2 + 2*0.3**2)

# Slightly Fixed the data from Table 9
# ggF
cen2, sig2m, sig2p = 1.12, np.sqrt(0.2**2 + 0.06**2 + 0.04**2)+0.01, np.sqrt(0.22**2+0.07**2+0.04**2)+0.01
# VBF
cen1, sig1m, sig1p = 3.9, np.sqrt(1.4**2 + 2*0.3**2), np.sqrt(1.7**2 + 2*0.3**2)
...
# fig.savefig('mu_VBF_ggH_2D_Poisson-VBF-marginal')
fig.savefig('mu_VBF_ggH_2D_Poisson-VBF-marginal-fixed')