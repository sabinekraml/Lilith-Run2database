...
Z = griddata(y, x, z2, xi, yi, interp="linear")

# Plot exp
f = open('HIGG_2016-21-CgCgaga-2d-Grid.txt', 'r')
...
locx = textt[0]
locy = textt[1]
plt.plot(locx, locy, '.', markersize=1, color='blue', label='ATLAS-HIGG-2016-21')
...
ax.contourf(xi,yi,Z,[10**(-10),2.3,5.99,11.83],colors=['#ff6600','#ffa500','#ffff00'], \
